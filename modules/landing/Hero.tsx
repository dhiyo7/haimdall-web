...
export const Hero: React.FC = () => {
  return (
    <section id="home" className="bg-white border-b-4 border-black">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="font-mono text-lg md:text-xl border-l-4 border-black pl-4">
              ...
              <p className="text-sm text-gray-600">
                Dibuat dengan ❤️ dan rasa kekhawatiran yang tinggi oleh <a href="https://github.com/dhiyo7" className="underline font-bold hover:text-black">dhiyo7</a>.
              </p>
            </div>
          ...
          <div className="relative hidden md:flex justify-center items-center order-first md:order-none">
            ...
            <div className="relative z-10 w-full max-w-sm">
              <div className="border-4 border-black p-2 bg-white shadow-retro-lg transform rotate-2 hover:rotate-0 transition-transform duration-300">
                <img
                  src="/heimdall-hero.jpg"
                  alt="Heimdall Guardian"
                  className="w-full h-auto border-2 border-black grayscale hover:grayscale-0 transition-all duration-500"
                />
              </div>
            </div>
          </div>
