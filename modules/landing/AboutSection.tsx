              ...
              <div className="space-y-8">
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-sans font-bold text-xl uppercase">Visi Jangka Panjang</h3>
                  </div>
                  <p className="font-mono text-sm md:text-base leading-relaxed pl-11">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-sans font-bold text-xl uppercase">Security (Quality Gate)</h3>
                  </div>
                  <p className="font-mono text-sm md:text-base leading-relaxed pl-11">
                    Heimdall adalah penjaga gerbang sebelum aplikasi dirilis ke user. Jika Heimdall bilang <span className="bg-red-500 text-white px-1 font-bold">"Merah"</span>, berarti dilarang rilis!
                  </p>
                </div>
              </div>
            </WindowCard>
